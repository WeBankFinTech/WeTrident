...
import { AppNavigator, WeBaseScene, Button, ActionSheet } from '@webank/trident'
...
export default class FrameworkScene extends WeBaseScene {
  ...
  render () {
    return (
      ...
      >
        <Button
          text='Navigation' style={{ marginTop: 10 }} onPress={() => {
            AppNavigator.example.NavigationScene()
          }}
        />

        <Button
          text='Network' style={{ marginTop: 10 }} onPress={() => {
            AppNavigator.example.NetworkScene()
          }}
        />

        <Button
          text='State Management' style={{ marginTop: 10 }} onPress={() => {
            AppNavigator.example.StateManagementScene()
          }}
        />
        <Button
          style={{ marginTop: 10 }} text='Console log' onPress={() => {
            ActionSheet.show({
