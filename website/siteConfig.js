...
const siteConfig = {
  ...
  headerLinks: [
    { doc: "introduction/getting-started", label: "快速开始" },
    { href: "http://git.weoa.com/app/trident", label: "Gitlab" },
  ...
  */
  ...
  copyright: 'Copyright (c) 2015-present 微众银行App团队',
