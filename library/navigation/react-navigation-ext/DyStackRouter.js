...
import createConfigGetter from '@unpourtous/react-navigation/src/routers/createConfigGetter';
import getScreenForRouteName from '@unpourtous/react-navigation/src/routers/getScreenForRouteName';

import validateRouteConfigMap from '@unpourtous/react-navigation/src/routers/validateRouteConfigMap';
import getScreenConfigDeprecated from '@unpourtous/react-navigation/src/routers/getScreenConfigDeprecated';
import invariant from '@unpourtous/react-navigation/src/utils/invariant';
import { generateKey } from '@unpourtous/react-navigation/src/routers/KeyGenerator';
...
export default (routeConfigs, stackConfig = {}) => {
  ...
  const getChildRouters = () => {
    ...
    return {childRouters, routeNames}
  }
  const {childRouters, routeNames} = getChildRouters()
  ...
  return {
    ...
    getActionForPathAndParams(pathToResolve, inputParams) {
      const {childRouters} = getChildRouters()
